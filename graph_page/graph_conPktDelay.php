    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col" style="text-align:right;">
          <button type="button" class="btn btn-default" data-container="body" data-toggle="popover" data-placement="left" title="The average of connection delay" data-html="true" data-content="Node(bule): source ip address<br>Node(green): time range delay<br>Link: number of connection">
            <label></label>
          </button>
        </div>
