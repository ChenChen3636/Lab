...
$json_string = file_get_contents("./graph_driver/data/d3js_conPktDelay.json");
  ...
  <div  style="border:10px rgba(255,255,255,0) solid; ">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col" style="text-align:right;">
          <button type="button" class="btn btn-default" data-container="body" data-toggle="popover" data-placement="left" title="The average of connection delay" data-html="true" data-content="Node(bule): source ip address<br>Node(green): time range delay<br>Link: number of connection<br><br>data range: <?php echo $timeRange_data?>">
            <label></label>
          </button>
        </div>
    ...
    <div class="collapse" id="set_condition">
      <div class="card card-body">
        ...
        <form action="./graph_driver/dataFilter_conPktDelay.php" method="GET">

          <div class="form-group">
            <h5><label for="data_time_range">Time range</label><br></h5>
            <input type="text" class="form-control" name="daterange_conPktDelay"  value="<?php echo $_GET["lastDate"]?>" >
          </div>
          ...
          <div class="form-group">
            <div class="card-body">
              <h5 class="card-header"><input type="checkbox" onchange="document.getElementById('srcIpFilter_conPktDelay').disabled = !this.checked; " name='ipCheckbox'/> IPv4 filter</h5>
              
                <label for="srcIp_filter">Source</label>
                <input type="text" class="form-control" name="srcIpFilter_conPktDelay"  id="srcIpFilter_conPktDelay" minlength="7" maxlength="15" size="15" pattern="^((\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.){3}(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])|(n\.n\.n\.n)$" disabled="disabled" placeholder="XXX . XXX . XXX . XXX" required>
...
$(function() {
  $('input[name="daterange_conPktDelay"]').daterangepicker({
    opens: "left",
    timePicker: true,
...
d3.json("./graph_driver/data/d3js_conPktDelay.json", function(error, graph) {
  ...
  var lables = node.append("text")
      .text(function(d) {
      	if(d.group == 2){
      		return (d.node_attr-5).toString() + "\~"+ d.node_attr.toString();
