...
$json_string = file_get_contents("./graph_driver/data/d3js_ipAB.json");
        ...
        <div class="col">
          <table>
            <tr>
                ...
                <td>&nbsp;</td>
                <td><p><a class="btn btn-secondary btn-sm" href="./graph_ip.php" role="button" >switch to src</a></p></td>   
            </tr>
          </table>
        </div>
...
$(function() {
  $('input[name="daterange_ip"]').daterangepicker({
    opens: "left",
    timePicker: true,
  ...
  var circles = node.append("circle")
      .attr("r", function(d) {       //node size
        if(d.group == 1){
          ...
          return 7+Math.pow(d.des_link_num, 1/3);
        }
      })
