...
def main():
  ...
  cursor_packet = mycol_packet.find({"Fourth_Layer.Destination_Port": {"$exists": "true"}, "$and": [ { "Arrival_Time": {"$gt": s_timeStamp} }, { "Arrival_Time": {"$lt": e_timeStamp} }]})    #check Fourth_Layer exist
