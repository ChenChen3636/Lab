...
$json_string = file_get_contents("./graph_driver/data/d3js_macAB.json");
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col" style="text-align:right;">
          <button type="button" class="btn btn-default" data-container="body" data-toggle="popover" data-placement="left" title="MAC topology" data-html="true" data-content="Node: mac address<br>Link: number of connection<br><br>data range: <?php echo $timeRange_data?>">
            <label></label>
          </button>
        </div>
