<ul class="pagination">
    <li class="page-item disabled" id="prevPage">
        <a class="page-link" href="###" value="0"><i class="fas fa-chevron-up"></i></a>
    </li>
    ...
    $(window).scroll(function(){
        ...
        $.each($(".paginationBlock"), function(index, element){
            ...
            if((pageElement - scroll_y) < 30){
                $(element).children(".pagination").css({"position":"fixed","top":"20px"});
            }else{
                $(element).children(".pagination").css({"position":"unset"});
            }
        });
    });
});
